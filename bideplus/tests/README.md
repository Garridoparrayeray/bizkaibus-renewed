...
python tests/static-checks.py && python tests/api-smoke.py && node tests/ui-battery.mjs && node tests/ui-offline.mjs && node tests/ui-alerts.mjs && node tests/ui-nearby.mjs
```
